...
## Mission
{What is this project trying to achieve? 1-2 sentences.}

## OKRs (90-Day)

### O1: {Objective 1}
- KR1: {Key Result — measurable}
- KR2: {Key Result — measurable}
- KR3: {Key Result — measurable}
...
## Channels
- **{channel-1}** — {purpose} ({N} agents)
- **{channel-2}** — {purpose} ({N} agents)
