...
| Direct inbox | Write JSON to agents/{slug}/inbox/ | Private message between agents |
...
- To a single agent: Write a task to agents/{slug}/inbox/ as a JSON message.
- To all agents: Write to shared/inbox/ for broadcast messages.
...
[writes task to agents/marketing-lead/inbox/directive.json]
