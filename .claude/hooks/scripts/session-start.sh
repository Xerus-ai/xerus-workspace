...
mkdir -p "$WORKSPACE_ROOT/.system/.memory/agents/$AGENT_SLUG"

# Touch working.md if it doesn't exist
if [ ! -f "$WORKSPACE_ROOT/.system/.memory/agents/$AGENT_SLUG/working.md" ]; then
  echo "# Working Memory" > "$WORKSPACE_ROOT/.system/.memory/agents/$AGENT_SLUG/working.md"
  echo "" >> "$WORKSPACE_ROOT/.system/.memory/agents/$AGENT_SLUG/working.md"
  echo "No previous session state." >> "$WORKSPACE_ROOT/.system/.memory/agents/$AGENT_SLUG/working.md"
fi
