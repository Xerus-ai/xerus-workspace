...
## Role
Pull metrics from company.db, channel context files, and data/dashboard/. Compute trends and generate performance reports.

## Process
1. Read `drive/company.md` for company goals and north star metric
